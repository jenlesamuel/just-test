...
var argv = minimist(process.argv.slice(2), {
  default: {
    ...
    //as_uri: "https://fff9636dead4.ngrok-free.app/",
  }
});
...
function register(id, name, ws, callback) {
  ...
  const iceConfiguration = JSON.parse(process.env.ICE_CONFIG || `{}`);
  // For ngrok
  // const iceConfiguration = JSON.parse(`{
  //   "iceServers": [
  //     {
  //       "urls": ["turn:fff963
  //   const iceConfiguration = JSON.parse(`{
  //   "iceServers": [
  //     {
  //       "urls": ["turn:2.tcp.eu.ngrok.io:16464?transport=tcp"],
  //       "username": "webrtcuser",
...
//   "iceServers": [
//     {
//       "credential": "ail4be8eiziuqu8jooN3Aequ",
//       "urls": [ 
// "turn:a79920b80467a0e8b.awsglobalaccelerator.com:3478?transport=udp"
//       ],
//       "username": "livechat-backend-stunner-production"
//     }
//   ],
